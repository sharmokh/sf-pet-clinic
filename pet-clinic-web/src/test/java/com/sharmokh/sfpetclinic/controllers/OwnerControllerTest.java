...
class OwnerControllerTest {
    ...
    void setUp() {
        owners = new HashSet<>();
        owners.add(Owner.builder().id(1L).firstName("Jack").build());
        owners.add(Owner.builder().id(2L).firstName("Laura").build());
    ...
    @Test
    void testCreateNewOwner() throws Exception {
    ...
    @Test
    void testProcessCreateNewOwner() throws Exception {
    ...
    @Test
    void testProcessUpdateOwner() throws Exception {
        when(ownerService.save(ArgumentMatchers.any())).thenReturn(Owner.builder().id(1L).build());
